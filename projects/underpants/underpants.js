...
//using dot notation to add  a key of identity to the _ object and im assigning a function as a value
...
*       Types are one of:
*          - "string"
*          - "array" // independent test
*          - "object" // independent test
*          - "undefined"
*          - "number"
*          - "boolean"
*          - "null" // independent test
*          - "function"
* Examples:
* _.typeOf(134) -> "number"
...
_.each = function(collection, func){
  // if colleciton is an array
    if(Array.isArray(collection)){
        for (let i = 0; i < collection.length;i++) {
            func(collection[i], i, collection); // invoking the function on each element in array
     }
    } else {  //else it's an object
        for(var key in collection) {
        func(collection[key], key, collection); // invoking the function on each value in the array 
    }
 }
}

...
function join(stringOne, stringTwo) {
    ...
    var args = Array.from(arguments);
        ...
        //return the new variable joines with an empty string
        return args.join('');
...
function longest(stringOne, stringTwo) {
    // YOUR CODE BELOW HERE //
    //compare the length of the two strings returning the longest string
    if (stringOne.length > stringTwo.length) {
        return stringOne;
    } else {
        //else just return the other string
        return stringTwo;
    }
